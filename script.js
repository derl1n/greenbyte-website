...
(function () {
  ...
  const T = {
    en: {
      ...
      team_role1: 'Project Lead & Architect',
      team_bio1: 'Leader and main developer of GreenByte. Responsible for the concept, architecture, web platform, Windows app, achievements system and team coordination.',
    ...
    uk: {
      ...
      team_role1: 'Project Lead & Architect',
      team_bio1: 'Керівник та головний розробник GreenByte. Відповідає за концепцію, архітектуру, вебплатформу, Windows-застосунок, систему досягнень та координацію команди.',
